...
const Topbar = () => {
  ...
  return (
    <ul className="flex items-center gap-1">
      ...
      <li>
        <Link
          className="group relative flex flex-shrink-0 items-center gap-2.5 rounded-sm py-2 pr-4 font-medium text-black duration-300 ease-in-out "
          href="/"
        >
          <Image
            width={32}
      ...
      <li>
        <Link
          href="/"
          className={`group relative flex items-center gap-2 rounded-sm px-3 py-2 font-medium text-black duration-300 ease-in-out hover:bg-bodydark1 dark:text-bodydark1 dark:hover:bg-meta-4 ${
            (pathname === "/" || pathname.includes("dashboard")) &&
            "border-t-2 border-green-500 bg-bodydark1 dark:border-bodydark1 dark:bg-meta-4"
          }`}
        >
          <svg
      ...
      <li className="group relative">
        ...
        <ul className="absolute hidden w-50 space-y-1 bg-white pt-2 shadow-md group-hover:block dark:bg-meta-4">
          <li>
            <Link
              href="/ui/alerts"
              className={`group relative flex items-center gap-2 rounded-sm px-3 py-2 font-medium text-black duration-300 ease-in-out hover:bg-bodydark1 dark:text-bodydark1 dark:hover:bg-meta-4 ${
                pathname === "/ui/alerts" && "bg-bodydark1 dark:bg-meta-4"
              }`}
            >
              Alerts
            </Link>
          ...
          <li>
            <Link
              href="/ui/buttons"
              className={`group relative flex items-center gap-2 rounded-sm px-3 py-2 font-medium text-black duration-300 ease-in-out hover:bg-bodydark1 dark:text-bodydark1 dark:hover:bg-meta-4 ${
                pathname === "/ui/buttons" && "bg-bodydark1 dark:bg-meta-4"
              } `}
            >
              Buttons
            </Link>
